...
- [ ] Task: Ověřit, že `smart_money_scraper.py` správně zpracovává a ukládá zvýšený objem dat.
- [ ] Task: Spustit `tests/rebuild_test_data.py` a ověřit v DB, že existují trhy s > 20 holdery.
